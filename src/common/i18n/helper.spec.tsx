...
it("(1) safeHtml - safe tags && attrs", async () => {
  const input = `
        <h3>Foo bar baz</h3>
        <p>Lorem ipsum <a href=\"https://upvu.org\" target=\"_blank\" rel=\"noopener noreferrer\">dolor</a> sit amet, <span class=\"highlight"\>consectetur</span> adipiscing elit.</p>
        <p>Cras eu turpis et mi <strong>vestibulum</strong> viverra eget a orci.</p>
        <p><img src=\"https://upvu.org/logo.png"\ alt=\"Logo"\ /></p>
        <br>
