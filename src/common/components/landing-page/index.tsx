        ...
        <div className="part-bottom">
          <div className="inner">
            ...
            <div className="image-wrapper">
              <img className="landing-floating-image" src={WhaleCatchsFish} alt="whale" loading="lazy" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="part-top pt-sm-5 pt-lg-0">
          <div className="inner">
            <div className="img-wrapper">
              <img className="decentralization-img" src={Decentralization} alt="decentralization" loading="lazy" />
            </div>
          ...
          <div className="inner">
            ...
            <div className="text-group">
              ...
              <Link
                ...
                onClick={() =>
                  isElectron() &&
                  window.open("https://ios.ecency.com/", "_blank", "top=500,left=200,frame=false,nodeIntegration=no")
                }
              >
                <img
