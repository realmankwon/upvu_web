...
import { getFollowing, getFollowers, getAccounts } from "../../api/steem";
  ...
  render() {
    ...
    const title =
      account.__loaded && account.follow_stats
        ? _t("friends.followers", { n: formattedNumber(account.follow_stats.follower_count, { fractionDigits: 0 }) })
        : "";
...
export class Following extends Component<Props> {
  render() {
    ...
    const title =
      account.__loaded && account.follow_stats
        ? _t("friends.following", { n: formattedNumber(account.follow_stats.following_count, { fractionDigits: 0 }) })
        : "";
