...
import { PrivateKey, KeyRole } from "@upvu/dsteem";
                ...
                <div>
                  <Form.Group>
                    ...
                    <InputGroup onClick={() => this.copyToClipboard(keys.owner)}>
                      <Form.Control value={truncate(keys.owner, 30)} disabled={true} className="text-primary pointer" />
                      <InputGroup.Append>
                        <Button
                          variant="primary"
                          size="sm"
                  ...
                  <Form.Group>
                    ...
                    <InputGroup onClick={() => this.copyToClipboard(keys.memo)}>
                      <Form.Control value={truncate(keys.memo, 30)} disabled={true} className="text-primary pointer" />
                      <InputGroup.Append>
                        <Button
                          variant="primary"
                          size="sm"
