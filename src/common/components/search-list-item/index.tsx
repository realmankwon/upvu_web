...
class SearchListItem extends Component<Props> {
  ...
  render() {
    ...
    const img: string =
      (global.canUseWebp ? catchPostImage(res.body, 600, 500, "webp") : catchPostImage(res.body, 600, 500)) || noImage;
          ...
          <div className="item-header-main">
            <div className="author-part">
              {ProfileLink({
                ...
                username: res.author,
                children: (
                  <a className="author-avatar">{UserAvatar({ ...this.props, username: res.author, size: "small" })}</a>
                ),
              })}
              {ProfileLink({
                ...this.props,
