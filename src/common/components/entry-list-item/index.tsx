...
export default class EntryListItem extends Component<Props, State> {
  ...
  render() {
    ...
    const imgGrid: string =
      (global.canUseWebp ? catchPostImage(entry, 600, 500, "webp") : catchPostImage(entry, 600, 500)) || noImage;
    const imgRow: string =
      (global.canUseWebp ? catchPostImage(entry, 260, 200, "webp") : catchPostImage(entry, 260, 200)) || noImage;
    ...
    return mounted && !this.state.showMuted ? (
