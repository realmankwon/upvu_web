...
import { getImages, deleteImage, UserImage, proxifyImageSrcConvert } from "../../api/private-api";
          ...
          <div className="gallery-list">
            <div className="gallery-list-body">
              {items.map((item) => {
                ...
                return (
                  <div className="gallery-list-item" style={{ backgroundImage: `url('${src}')` }} key={item._id}>
                    <div
