...
export class Purchase extends BaseComponent<Props, State> {
  ...
  render() {
    ...
    if (submitted) {
      return (
        <Transfer {...this.props} asset={asset} mode="transfer" amount={`${amount}`} to="esteem.app" memo="points" />
      );
    }
    ...
    return (
      <div className="purchase-dialog-content">
          ...
          <div className="nav nav-pills">
            <div className="nav-item">
              <a
                ...
                className={_c(`nav-link ${asset === "STEEM" ? "active" : ""}`)}
              >
                STEEM
              </a>
            </div>
            <div className="nav-item">
              <a
                ...
                className={_c(`nav-link ${asset === "SBD" ? "active" : ""}`)}
              >
                SBD
              </a>
            </div>
        ...
        <div className="input-amounts">
          <div className="asset-amount">{`${formattedNumber(amount, { fractionDigits: 3 })} ${asset}`}</div>
