            ...
            <div className="d-flex justify-content-between flex-wrap">
              <div className="flex-grow-1 d-flex border-bottom">
                <div className="p-3 flex-grow-1">
                  ...
                  <div className="text-break-wrap">
                    {loading ? <Skeleton className="loading-md" /> : profile && dateToFullRelative(profile.created)}
                  </div>
                </div>

                <div
                  className={`p-3 flex-grow-1 ${loading ? "" : profile && profile.profile.location ? "" : "d-none"}`}
                >
                  <b>{_t("profile-edit.location")}</b>
                  <div className="text-break-wrap">
                    {loading ? <Skeleton className="loading-md" /> : (profile && profile.profile.location) || "---"}
                  </div>
                </div>
              </div>
              ...
              <div className="flex-grow-1 d-flex border-bottom">
                ...
                <div className="p-3 flex-grow-1">
                  ...
                  <div className="text-break-wrap">
                    {loading ? <Skeleton className="loading-md" /> : profile && profile.voting_power / 100}
                  </div>
                </div>
              </div>
