...
export const ProfileCard = (props: Props) => {
  ...
  if (!account.__loaded) {
    return (
      <div className="profile-card">
        <div className="profile-avatar">{UserAvatar({ ...props, username: account.name, size: "xLarge" })}</div>
  ...
  const isMyProfile =
    activeUser && activeUser.username === account.name && activeUser.data.__loaded && activeUser.data.profile;
