...
export const entryInstance1: Entry = {
    ...
    payout: 125.095,
    pending_payout_value: "125.095 SBD",
...
export const crossEntryInstance: Entry = {
    ...
    "original_entry": {
        ...
        "payout": 5.946,
        "pending_payout_value": "5.946 SBD",
        "author_payout_value": "0.000 SBD",
        "curator_payout_value": "0.000 SBD",
        "promoted": "0.000 SBD",
        "replies": [],
...
export const openOrdersInstance: OpenOrdersData[] = [
    {
        ...
        rewarded: false,
        sell_price: {base: '200.000 STEEM', quote: '300.000 SBD'}
    },
];
export const discussionInstace1: Entry[] = [
    {
        ...
        payout: 11.432,
        pending_payout_value: "11.432 SBD",
        author_payout_value: "0.000 SBD",
        curator_payout_value: "0.000 SBD",
        promoted: "0.000 SBD",
        replies: [],
    ...
    },
    {
        ...
        payout: 0.031,
        pending_payout_value: "0.031 SBD",
        author_payout_value: "0.000 SBD",
        curator_payout_value: "0.000 SBD",
        promoted: "0.000 SBD",
        replies: [],
    ...
    },
    {
        ...
        payout: 0.032,
        pending_payout_value: "0.032 SBD",
        author_payout_value: "0.000 SBD",
        curator_payout_value: "0.000 SBD",
        promoted: "0.000 SBD",
        replies: [],
    ...
    },
    {
        ...
        title: "RE: Esteem Discord Monthly Giveaway Winners #21",
        body:
            "Great to see my name on the Giveaway and I like quite much engaging on Discord and find out what others are doing in the STEEM space. A source of news, common hobbies and other topics that rise up your day.",
        json_metadata: {},
        ...
        payout: 0.077,
        pending_payout_value: "0.077 SBD",
        author_payout_value: "0.000 SBD",
        curator_payout_value: "0.000 SBD",
        promoted: "0.000 SBD",
        replies: [],
...
export const assetSymbolInstance: AssetSymbol = "SBD"
