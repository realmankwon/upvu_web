...
import LeftSideArea from "../components/left-side-area";
      ...
      <>
        {
          <div className={containerClasses}>
            {global.listStyle === ListStyle.deck ? (
              ...
              <>
                <div className="tags-side">{!global.isMobile && <>{LeftSideArea({ ...this.props })}</>}</div>
                <div className={_c(`entry-page-content ${this.props.loading ? "loading" : ""}`)}>
                  ...
                  <div className={_c(`entry-list ${this.props.loading ? "loading" : ""}`)}>
                    <div
                      className={_c(
                        `entry-list-body limited-area ${global.listStyle === ListStyle.grid ? "grid-view" : ""}`
                      )}
                    >
