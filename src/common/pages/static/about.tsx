          ...
          <div className="contacts">
            ...
            <div className="contacts-links">
              <a
                ...
                target="_blank"
                href="https://upvu.org/@good-karma"
                rel="noopener noreferrer"
              >
                {blogSvg} {_t("static.about.contact-blog")}
              </a>
              <a className="contacts-link" target="_blank" href="https://upvu.org/@ecency" rel="noopener noreferrer">
              ...
              <a className="contacts-link" target="_blank" href="https://github.com/ecency" rel="noopener noreferrer">
                {githubSvg} Github
              </a>
              <a className="contacts-link" target="_blank" href="https://t.me/ecency" rel="noopener noreferrer">
                {telegramSvg} Telegram
              </a>
              <a className="contacts-link" target="_blank" href="https://discord.me/ecency" rel="noopener noreferrer">
                {discordSvg} Discord
              </a>
            </div>
          </div>
