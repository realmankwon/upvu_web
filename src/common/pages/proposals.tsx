...
import { renderPostBody, setProxyBase, catchPostImage } from "@upvu/render-helper";
  ...
  applyFilter = (filter: Filter) => {
    ...
    switch (filter) {
      ...
      case Filter.TEAM:
        proposals = [
          ...proposals_.filter(
            (x) => ["ecency", "good-karma", "hivesearcher", "hivesigner"].includes(x.creator) && x.status === "active"
          ),
        ];
        break;
    }
