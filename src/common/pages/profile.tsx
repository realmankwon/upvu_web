...
import WalletHiveEngine from "../components/wallet-steem-engine";
...
class ProfilePage extends BaseComponent<Props, State> {
  ...
  componentDidUpdate(prevProps: Readonly<Props>): void {
    ...
    if (
      ["comments", "replies"].includes(global.filter) &&
    ...
    const prevAccount = prevAccounts.find(
      (x) => x.name === accountUsername
    ) as FullAccount;
  ...
  render() {
    ...
    const { loading, search, searchDataLoading, searchData, typing } =
      this.state;
