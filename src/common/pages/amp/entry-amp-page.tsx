        ...
        <div className={containerClasses}>
          <div className="the-entry">
            ...
            <div itemScope={true} itemType="http://schema.org/Article">
              ...
              <meta itemProp="mainEntityOfPage" content={`https://upvu.org/@${entry.author}/posts`} />
              <span itemProp="publisher" itemScope={true} itemType="http://schema.org/Organization">
                ...
                <meta
                  itemProp="url"
                  content={`https://upvu.org/created/${entry.community ? entry.community : "hive-125125"}`}
                />
                                        ...
                                        <div className="author notranslate">
                                          <span className="author-name">
                                            ...
                                            >
                                              ...
                                              <meta
                                                itemProp="url"
                                                content={`https://upvu.org/@${originalEntry.author}`}
                                              />
                                            </span>
                                          </span>
                                ...
                                <ul className="comment-entry-opts">
                                  ...
                                  {entry.depth > 1 && (
                                    <li>
                                      <Link
                                        to={
                                          makeEntryPath(entry.category, entry.parent_author!, entry.parent_permlink!) +
                                          "?amps"
                                        }
                                      >
                                      ...
                                      <div className="author notranslate">
                                        <span className="author-name">
                                          <span itemProp="author" itemScope={true} itemType="http://schema.org/Person">
                                            ...
                                            <meta itemProp="url" content={`https://upvu.org/@${entry.author}`} />
                                          </span>
                                        </span>
                                        <span className="author-reputation" title={_t("entry.author-reputation")}>
                                          {reputation}
